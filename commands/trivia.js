...
module.exports = {
		name: "trivia",
		description: "Gives you a random question to answer in 10 seconds!",/**
        ...
        */
        ...
        const TriviaEmbed = new MessageEmbed()
            ...
            .then(() => {
                interaction.channel.awaitMessages({ filter, max: 1, time: 5000 })
                    .then(collected => {
                        const winner =collected.first().author;
                        interaction.followUp(`${winner} got the correct answer!`);
                    })
